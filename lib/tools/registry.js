...
import { calculateStrategyDef } from './definitions/strategy';
import { calculateEventStrategy } from './implementations/strategy';
import { searchKnowledgeBaseDef } from './definitions/knowledge';
import { searchKnowledgeBase } from './implementations/knowledge';
...
const registry = [
    ...
    {
        definition: calculateStrategyDef,
        implementation: calculateEventStrategy,
    },
    {
        definition: searchKnowledgeBaseDef,
        implementation: searchKnowledgeBase,
    },
    // 未來新增工具只需在這裡加入：
